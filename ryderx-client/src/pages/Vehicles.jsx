...
export default function Vehicles() {
  ...
  const initialPickup =
    queryParams.get("pickup") || "Kempegowda International Airport";
  const initialDropoff =
    queryParams.get("dropoff") || "Kempegowda International Airport";
  const initialPickupDate = queryParams.get("pickupDate") || "2025-09-28T10:00";
  const initialDropoffDate =
    queryParams.get("dropoffDate") || "2025-10-01T10:00";
            ...
            >
              ...
              <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
                ...
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  <AccessTimeIcon fontSize="small" />
                  <Typography>
                    {new Date(dropoffDate).toLocaleString()}
                  </Typography>
                </Box>
              </Box>
            </Box>
